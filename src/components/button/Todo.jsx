...
const Todo = () => {
    ...
    return (
        ...
        '>
            {/* ---- title */}
            <div className="flex items-cenetr mt-7 gap-2">
            ...
            <div>
                ...
                {todoList.map((item, index) => {
                    return < TodosItems key={index} text={item.text} id={item.id} isComplete={item.isComplete} deleteTodo={deleteTodo} toggle={toggle} />
                })}
